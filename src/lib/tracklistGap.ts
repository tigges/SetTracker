...
const WEEKLY_RADIO =
  /\b(radio\s*(show|ep\.?|#)?|on air|captive soul|selects|clapcast|desire radio|resonation|dharma|spannung|group therapy|a state of trance|\basot\b|gdwb|gdjb|hot robot|steve radio|smash the house radio|night owl radio|core radio|night service|protocol radio|prismatic)\b/i;
