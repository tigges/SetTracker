...
export const DJ_SOCIAL_PINS: DjSocialPin[] = [
  ...
  },
  {
    ...
    name: "DJ Snake",
    accent: "#80ffdb",
    soundcloud: "https://on.soundcloud.com/S9sG4NR19uG0xp1HZT",
    youtube: "https://www.youtube.com/@djsnake",
    instagram: null,
    website: "https://djmag.com/top100djs/2025/40/dj-snake",
    bio: "Trap / Bass. YT @djsnake (25M), SC on.soundcloud shortlink.",
  },
  {
    slug: "michael-bibi",
    name: "Michael Bibi",
  ...
  },
  {
    ...
    name: "Mariana Bo",
    accent: "#e63946",
    // SC marianabo / mariana-bo are wrong-person stubs — leave null.
    soundcloud: null,
    youtube: "https://www.youtube.com/@marianabo",
    instagram: null,
    website: "https://djmag.com/top100djs/2025/91/mariana-bo",
    bio: "Hardstyle. YT @marianabo. No verified SC in this pass.",
  },
  {
    slug: "fantasm",
    name: "Fantasm",
    ...
    bio: "Hard Techno. YT @fantasm_techno (not bare @fantasm). No verified SC.",
  },
  {
    slug: "vinai",
    name: "VINAI",
