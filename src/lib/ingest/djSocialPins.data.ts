...
export const DJ_SOCIAL_PINS: DjSocialPin[] = [
  ...
  },
  {
    ...
    bio: "Progressive House. SC kaaze, YT @KAAZEOfficial (not bare @KAAZE).",
  },
  {
    slug: "burak-yeter",
    name: "Burak Yeter",
  ...
  },
  {
    ...
    bio: "Melodic Techno. SC wukongofficial, YT @WUKONGofficial (not bare @wukong).",
  },
  {
    slug: "fedde-le-grand",
    name: "Fedde Le Grand",
  ...
  // Handle-gap batch — profile-verified only (reject soft-404 / wrong-person pages).
  {
    ...
    instagram: null,
    website: "https://djmag.com/top100djs/2025/23/kshmr",
    bio: "Big Room / Festival. SC kshmr (~403k), YT channel UCFMjkrMT7Gvg84v0av-DIwA.",
  },
  {
    slug: "nicky-romero",
    name: "Nicky Romero",
    ...
    bio: "Progressive House. Official nickyromero.com — SC nickyromero, YT user/nickyromerotv.",
  },
  {
    slug: "dj-snake",
    name: "DJ Snake",
  ...
  },
  {
    ...
    instagram: null,
    website: "https://djmag.com/top100djs/2025/48/michael-bibi",
    bio: "Tech House. SC bibi-87, YT @michaelbibi (not @MichaelBibiOfficial).",
  },
  {
    slug: "alesso",
    name: "Alesso",
    ...
    instagram: null,
    website: "https://djmag.com/top100djs/2025/51/alesso",
    bio: "Progressive House. SC alesso (~743k), YT @alesso (~2.6M).",
  },
  {
    slug: "mochakk",
    name: "Mochakk",
    ...
    instagram: null,
    website: "https://djmag.com/top100djs/2025/56/mochakk",
    bio: "Tech House. SC mochakkmusic (not bare mochakk), YT @mochakk.",
  },
  {
    slug: "cuebrick",
    name: "Cuebrick",
    ...
    bio: "Big Room. SC cuebrick (~20k), YT @cuebrick.",
  },
  {
    slug: "mariana-bo",
    name: "Mariana Bo",
  ...
  },
  {
    ...
    bio: "Hard Techno. SC kenzo-meservey, YT @fantasm_techno (not bare @fantasm).",
  },
  {
    slug: "vinai",
    name: "VINAI",
  ...
  },
  {
    ...
    bio: "Future House. SC faustix, YT @faustixmusic (not bare @faustix).",
  },
  {
    slug: "honey-dijon",
    name: "Honey Dijon",
    ...
    bio: "House. SC honeydijon, YT @honeydijon. Not the Paris club Djoon.",
  },
  {
    slug: "nils-van-zandt",
    name: "Nils van Zandt",
  ...
  },
  {
    ...
    instagram: null,
    website: "https://djmag.com/top100djs/2025/100/marlon-hoffstadt",
    bio: "Trance / Hard Dance (DJ Daddy Trance). SC marlonhoffstadt, YT @marlonhoffstadt.",
  },
  {
    slug: "marshmello",
    name: "Marshmello",
  ...
  // Off-roster Top 100 → deep-scan batch (handles verified 2026-07-31).
  {
    ...
    bio: "Big Room. Official martingarrix.com — SC martingarrix, YT @MartinGarrix.",
  },
  {
    slug: "don-diablo",
    name: "Don Diablo",
    ...
    bio: "Future House. Official dondiablo.com — SC dondiablo, YT @DonDiablo.",
  },
  {
    slug: "steve-aoki",
    name: "Steve Aoki",
  ...
  },
  {
    ...
    bio: "Big Room. Official djhardwell.com — SC hardwell, YT @hardwell.",
  },
  {
    slug: "carl-cox",
    name: "Carl Cox",
  ...
  },
  {
    ...
    bio: "Progressive House. Official ericprydz.com — SC eric-prydz, YT @ericprydz.",
  },
  {
    slug: "amelie-lens",
    name: "Amelie Lens",
  ...
  },
  {
    ...
    bio: "Trance. Official paulvandyk.com — SC paulvandykofficial, YT @PaulvanDyk.",
  },
  {
    slug: "korolova",
    name: "Korolova",
    ...
    bio: "Melodic Techno. SC korolovadj, YT @KOROLOVADJ.",
  },
  {
    slug: "kolsch",
    name: "Kölsch",
    ...
    bio: "Melodic Techno. Official kolschofficial.com — SC kolsch, YT @KolschOfficial.",
  },
  {
    slug: "miss-monique",
    name: "Miss Monique",
  ...
  },
  {
    ...
    bio: "Trance. Official ferrycorsten.com — SC ferry-corsten, YT @FerryCorsten.",
  },
  {
    slug: "topic",
    name: "Topic",
