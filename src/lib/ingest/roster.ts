...
export const ARTIST_ROSTER_CURATED: ArtistRosterEntry[] = [
  ...
  },
  {
    ...
    youtube: {
      ...
      status: "weak",
      note: "official channel/UC8Bhgj67ino3eyL6WXvYgAA; About @antiup. yt-cZhNpGcYq_A is the full Mojave Coachella WE1 2024 set (album-titled What Is Life [Live From Coachella 2024], 70:27). Channel otherwise shorts/clips — keep weak so deep-scan does not ingest those.",
    },
    soundcloud: {
