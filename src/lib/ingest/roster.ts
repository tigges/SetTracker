...
export const ARTIST_ROSTER_CURATED: ArtistRosterEntry[] = [
  ...
  },
  {
    ...
    youtube: { handle: "@westend", status: "unverified" },
    soundcloud: {
    ...
    socials: ["https://soundcloud.com/itsthewestend"],
    priority: "normal",
  },
  {
