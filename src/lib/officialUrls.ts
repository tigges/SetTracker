 ...
 * ra.co as website. DICE / Shotgun / JamBase / Eventpop / PuntoTicket are tickets.
 * Follow a JamBase URL already in hand; do not crawl jambase.com.
 */

const WEAK_OFFICIAL =
  /6amgroup\.com|clubtickets\.com\/blog|djmag\.com\/top[-_]?100|djmag\.com\/?([?#]|$)|wikipedia\.org|wikidata\.org|(^|[/.])ra\.co([/?#]|$)|residentadvisor\.net|dice\.fm|shotgun\.live|jambase\.com|eventpop\.me|puntoticket\.com/i;
