...
const WEAK_OFFICIAL =
  /6amgroup\.com|clubtickets\.com\/blog|djmag\.com\/top[-_]?100|djmag\.com\/?([?#]|$)|wikipedia\.org|wikidata\.org|(^|[/.])ra\.co([/?#]|$)|residentadvisor\.net|technomusicworld\.com|dice\.fm|shotgun\.live|jambase\.com|eventpop\.me|puntoticket\.com/i;
