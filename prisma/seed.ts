...
type Prov = "1001tl" | "soundcloud" | "fingerprint" | "community" | "youtube";
type Entry =
...
async function main() {
  ...
  const eventData: Array<[string, string, string, string, string | null]> = [
    ...
    ["parklife", "Parklife", "festival", "Heaton Park, Manchester", "https://www.parklife.uk.com/"],
    ["elrow", "elrow", "club", "various", null],
    ["tomorrowland", "Tomorrowland", "festival", "Boom, Belgium", "https://www.tomorrowland.com/"],
    ["creamfields", "Creamfields", "festival", "Daresbury, UK", "https://www.creamfields.com/"],
    ["untold", "Untold Festival", "festival", "Cluj-Napoca, Romania", "https://untold.com/"],
    ["mysteryland", "Mysteryland", "festival", "Haarlemmermeer, Netherlands", "https://mysteryland.id-t.com/"],
    ["awakenings", "Awakenings", "festival", "Amsterdam, Netherlands", "https://www.awakenings.nl/"],
    ["mixmag", "Mixmag", "livestream", "various", "https://mixmag.net/"],
    ["boiler-room", "Boiler Room", "livestream", "various", "https://boilerroom.tv/"],
  ];
  ...
  const setDefs: SetDef[] = [
    ...
    {
      slug: "chris-lake-tomorrowland",
      title: "Tomorrowland Belgium · Mainstage",
      type: "festival",
      primary: "chris-lake",
      event: "tomorrowland",
      daysAgo: 4,
      ...
      tracklist: [
        ...
        id("all-night"),
        id("afterdark"),
        unid("Chris Lake - ID", "youtube", "Chris Lake"),
        id("feel-your-love"),
        res("ID - ID", "deceiver", "community"),
        raw("Mainstage ID", "youtube"),
      ],
    },
    {
      slug: "cloonee-creamfields",
      title: "Creamfields · Steel Yard",
      type: "festival",
      primary: "cloonee",
      event: "creamfields",
      daysAgo: 9,
      ...
      tracklist: [
        ...
        id("low-ride"),
        id("ratchet"),
        unid("Cloonee - ID", "youtube", "Cloonee"),
        id("superstar"),
        res("ID - ID", "get-loose", "community"),
        raw("Steel Yard dub", "youtube"),
      ],
    },
    {
      slug: "matroda-untold",
      title: "Untold Festival · Mainstage",
      type: "festival",
      primary: "matroda",
      event: "untold",
      daysAgo: 12,
      ...
      tracklist: [
        ...
        id("zamba"),
        id("vibrate"),
        unid("Matroda - ID", "youtube", "Matroda"),
        id("ratchet"),
        res("ID - ID", "superstar", "community"),
        raw("Mainstage ID", "youtube"),
      ],
    },
    {
      slug: "malaa-awakenings",
      title: "Awakenings Festival · Area W",
      type: "festival",
      primary: "malaa",
      event: "awakenings",
      daysAgo: 15,
      ...
      tracklist: [
        id("notorious"),
        id("lowkey"),
        unid("Malaa - ID", "youtube", "Malaa"),
        raw("Area W tool", "youtube"),
        id("prophecy"),
      ],
    },
    {
      slug: "tchami-mysteryland",
      title: "Mysteryland · Mainstage",
      type: "festival",
      primary: "tchami",
      event: "mysteryland",
      daysAgo: 18,
      ...
      tracklist: [
        id("prophecy"),
        id("ride"),
        unid("Tchami - ID", "youtube", "Tchami"),
        raw("Mysteryland dub", "youtube"),
        id("feel-your-love"),
      ],
    },
    {
      slug: "kyle-walker-mixmag",
      title: "Kyle Walker | Mixmag Lab London",
      type: "mix",
      primary: "kyle-walker",
      event: "mixmag",
      daysAgo: 2,
      ...
      tracklist: [
        id("work-it"),
        id("shake-it"),
        unid("Kyle Walker - ID", "youtube", "Kyle Walker"),
        id("get-down"),
        res("ID - ID", "freak", "community"),
      ],
    },
